...
export const CRAFT_COMPUTER_USE_PACKAGE_ROOT = path.resolve(
	path.dirname(fileURLToPath(import.meta.url)),
	"..",
	"..",
	"..",
);
export const CRAFT_SETUP_HELPER_SCRIPT = path.join(
...
export class MacosHelperClient {
	...
	async ensureInstalled(signal?: AbortSignal): Promise<void> {
		...
		await runProcess(process.execPath, [CRAFT_SETUP_HELPER_SCRIPT, "--runtime"], HELPER_SETUP_TIMEOUT_MS, signal, {
			...process.env,
