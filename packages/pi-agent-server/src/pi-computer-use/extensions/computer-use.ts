...
// Craft runtime overlay: upstream's defineTool helper is an identity function.
// Keeping that behavior local lets the generated extension bundle avoid a
// second runtime copy of pi-coding-agent while preserving ExtensionAPI typing.
...
export {
	CRAFT_COMPUTER_USE_PACKAGE_ROOT,
	CRAFT_SETUP_HELPER_SCRIPT,
} from "../src/platform/macos/helper.ts";
