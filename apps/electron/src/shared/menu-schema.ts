...
export const ROOT_MENU = {
  newChat: {
    ...
    ipcChannel: RPC_NAMESPACES.menu.NEW_CHAT,
    icon: 'SquarePen',
  },
  newWindow: {
    type: 'action',
    ...
    ipcChannel: RPC_NAMESPACES.menu.NEW_WINDOW,
    icon: 'AppWindow',
  },
  keyboardShortcuts: {
    type: 'action',
    ...
    shortcutDisplayMac: '',
    shortcutDisplayOther: '',
    ipcChannel: RPC_NAMESPACES.menu.KEYBOARD_SHORTCUTS,
    icon: 'Keyboard',
  },
  quit: {
    type: 'action',
    ...
    ipcChannel: RPC_NAMESPACES.menu.QUIT,
    icon: 'LogOut',
  },
...
export const DEBUG_MENU: MenuSection = {
  ...
  items: [
    ...
    { type: 'separator' },
    {
      ...
      ipcChannel: RPC_NAMESPACES.menu.TOGGLE_DEV_TOOLS,
      icon: 'Bug',
    },
  ],
}
 ...
 */
export function getShortcutDisplay(item: MenuItemAction | MenuItemRole | MenuItemUrl, isMac: boolean): string {
