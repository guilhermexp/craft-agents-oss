...
export function BrowserEmptyStateCard({
  ...
  return (
    <div className="w-full h-full flex items-center justify-center p-8">
      <div className="w-full max-w-[700px] bg-foreground-3 shadow-minimal rounded-[8px] overflow-hidden border border-border/30">
            ...
            <div className="mt-3.5 space-y-1.5">
              {prompts.map((sample, index) => (
                <button
                  ...
                  className="w-fit max-w-full flex items-center gap-1 h-8 px-2.5 rounded-[6px] bg-foreground-5 shadow-minimal hover:bg-foreground-10 transition-colors text-left cursor-pointer"
                >
