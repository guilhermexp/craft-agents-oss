...
const EXPECTED_CHANNELS: string[] = [
  ...
  "LLM_Connection:test",
  "appearance:getAutoExpandActivities",
  "appearance:getRichToolDescriptions",
  "appearance:setAutoExpandActivities",
  ...
  "browser-pane:fill",
  "browser-pane:focus",
  "browser-pane:get-profile-settings",
  "browser-pane:go-back",
  "browser-pane:go-forward",
  "browser-pane:import-cookies",
  "browser-pane:interacted",
  "browser-pane:list",
  "browser-pane:list-profiles",
  "browser-pane:navigate",
  "browser-pane:picker-requested",
  "browser-pane:preview-cookie-import",
  "browser-pane:profiles-changed",
  "browser-pane:reload",
  "browser-pane:removed",
  "browser-pane:rename-profile",
  ...
  "channels:delete",
  "channels:list",
  "channels:listDispatches",
  "channels:listMessages",
  "channels:messagesChanged",
  ...
  "hermes:detectInstallation",
  "hermes:getActiveProfile",
  "hermes:getApiConfig",
  "hermes:getProfileSetupCommand",
  "hermes:getProfileSoul",
  "hermes:getProviderModels",
  "hermes:getRuntimeDetails",
  "hermes:listEnv",
  "hermes:listHomeFiles",
  "hermes:listLogs",
  "hermes:listProfiles",
  "hermes:listSkills",
  "hermes:openPath",
  ...
  "hermes:setActiveProfile",
  "hermes:setEnv",
  "hermes:startDashboard",
  "hermes:updateProfileSoul",
  "hermes:updateRuntime",
  ...
  "meetings:archive",
  "meetings:delete",
  "meetings:getTranscriptionConfig",
  "meetings:list",
  "meetings:saveTranscriptionConfig",
  "meetings:start",
  "meetings:status",
  "meetings:stop",
  "meetings:transcript",
  ...
  "skills:openEditor",
  "skills:openFinder",
  "sources:catalogCapability",
  "sources:changed",
  "sources:create",
  "sources:delete",
  "sources:discoverCatalog",
  "sources:get",
  "sources:getMcpTools",
  "sources:getPermissions",
  "sources:materializeCatalog",
